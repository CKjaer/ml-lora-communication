...
current_folder = os.path.dirname(os.path.abspath(__file__))
models_folder = os.path.abspath(os.path.join(current_folder, '/ceph/project/LoRa_Symbol_Detection/ml-lora-communication/cnn_output/train_ML_models/FinalTesfeyModels/models'))
